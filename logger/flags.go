...
// These flags are here to help people using cobra easily add logging options
// I am going to be very opinionated and just use the zap concrete type (no interface)
package logger
...
var _ pflag.Value = &timeEncodingFlag{}
